...
function gyad_enqueue_assets() {
	...
	if ( is_singular() ) {
		...
		wp_enqueue_style( 'gyad-article-status-premium', GYAD_URI . '/assets/css/article-status-premium.css', array( 'gyad-article-author-source-premium' ), gyad_asset_version( 'assets/css/article-status-premium.css' ) );
		wp_enqueue_style( 'gyad-article-type-intelligence-premium', GYAD_URI . '/assets/css/article-type-intelligence-premium.css', array( 'gyad-article-status-premium' ), gyad_asset_version( 'assets/css/article-type-intelligence-premium.css' ) );
	}

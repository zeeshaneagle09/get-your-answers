...
foreach ( array( 'single.php', 'single-premium.php', 'single-navigation.php', 'article-author-source.php', 'performance.php', 'recommendations.php', 'accessibility.php', 'related-intelligence.php' ) as $gyad_inc_file ) {
